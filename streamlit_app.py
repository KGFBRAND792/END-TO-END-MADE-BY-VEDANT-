...
st.set_page_config(
    page_title="KATTAR HINDU VEDANT",
    page_icon="âœ…",
    layout="wide",
...
def main_app():
    ...
    if user_config:
        tab1, tab2 = st.tabs(["E2EE SET-UPLODE", " AUTOMATION"])
        ...
        with tab2:
            ...
            with col2:
                st.markdown('<div class="metric-container">', unsafe_allow_html=True)
                status = "ðŸŸ¢ RUNNING" if st.session_state.automation_state.running else "”´ STOP"
...
st.markdown('<div class="footer">MADE IN INDIA AVENGERS VEDANT 2026</div>', unsafe_allow_html=True)
